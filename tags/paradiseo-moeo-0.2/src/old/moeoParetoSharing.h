...
#include <old/moeoParetoPhenDist.h>
#include <eoParetoRanking.h>

template < class EOT, class worthT =
  double >class moeoParetoSharing:public eoPerf2Worth < EOT, worthT >
{
public:

  moeoParetoSharing (double _nicheSize):eoPerf2Worth < EOT,
  ...
  moeoParetoSharing (double _nicheSize, moeoParetoPhenDist < EOT,
