...
\begin{center}
\leavevmode
\includegraphics[height=3.96226cm]{classmoeoAdditiveEpsilonBinaryMetric}
\end{center}
\end{figure}
...
\begin{CompactItemize}
\item 
double \bf{epsilon} (const \bf{Objective\-Vector} \&\_\-o1, const \bf{Objective\-Vector} \&\_\-o2, const unsigned int \_\-obj)
...
References moeo\-Additive\-Epsilon\-Binary\-Metric$<$ Objective\-Vector $>$::epsilon(), and moeo\-Objective\-Vector$<$ Objective\-Vector\-Traits, double $>$::n\-Objectives().\index{moeoAdditiveEpsilonBinaryMetric@{moeo\-Additive\-Epsilon\-Binary\-Metric}!epsilon@{epsilon}}
...
References moeo\-Normalized\-Solution\-Vs\-Solution\-Binary\-Metric$<$ Objective\-Vector, R $>$::bounds.
