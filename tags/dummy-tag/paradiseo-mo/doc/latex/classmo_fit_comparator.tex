...
\begin{CompactList}\small\item\em \doxyref{Function} which makes the comparison and gives the result. \item\end{CompactList}\end{CompactItemize}
...
\doxyref{Function} which makes the comparison and gives the result. 
