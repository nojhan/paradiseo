...
#include <paradiseo/mo/neighborhood/moRndWithReplNeighborhood.h> // visit all neighbors in random order with neighbor
#include <paradiseo/mo/neighborhood/moOrderNeighborhood.h> // visit all neighbors in order with neighbor
