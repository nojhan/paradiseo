...
//!
//! ParadisEO-PEO is a white-box object-oriented framework dedicated to the reusable design
//! of parallel and distributed metaheuristics (PDM). ParadisEO-PEO provides a broad range of features including evolutionary
//! algorithms (EA), local searches (LS), the most common parallel and distributed models and hybridization
//! mechanisms, etc. This high content and utility encourages its use at European level. ParadisEO-PEO is based on a
...
//! provided by the framework allow a higher flexibility compared to other frameworks. ParadisEO-PEO is one of the rare
...
//!
//! The "EO" part of ParadisEO-PEO means Evolving Objects. EO is a C++ LGPL open source
...
//! facilities, on-line definition of parameters, application check-pointing, etc. ParadisEO-PEO is an
...
//! the next sections, we present the motivations and goals of ParadisEO-PEO, its architecture and
...
//! following criteria are the major of them and constitute the main objectives of the ParadisEO-PEO
//! framework:
//!
//! <ul>
...
//! </ul>
//!
//! \subsection architecture ParadisEO-PEO architecture
//!
//! The architecture of ParadisEO-PEO is multi-layer and modular allowing to achieve the objectives
...
//! fixed but not implemented in ParadisEO-PEO. The programmer has the burden to develop them
